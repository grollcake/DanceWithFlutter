      ...
      body: Container(
        ...
        child: _foundedUsers.length > 0 ? ListView.builder(
            ...
            _foundedUsers.length,
              ...
              }) : Center(child: Text('No user found', style: TextStyle(color:Colors.white),),),
      ),
    );
  }
        ...
        children: <Widget>[
          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Center(
                child: Text(user.isFollowedByMe ? 'Unfollow' : 'Follow', style: TextStyle(color: Colors.white),),
              ),
            ),
          )
        ],
